...
const FORMS_URL =
  'https://docs.google.com/forms/d/e/1FAIpQLSfqTXSpCu1fehucOOjt7nhW-pQRrHN8XNfM9YdcRQZ-CigSEw/viewform?usp=header';
  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-slate-900/40 backdrop-blur-md rounded-[3rem] p-10 md:p-16 shadow-2xl border border-white/5 text-center">
        ...
        <h1 className="text-4xl font-black text-white mb-6 tracking-tighter italic uppercase">
          Contacta-nos
        </h1>
